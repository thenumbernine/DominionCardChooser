	...
	var extendSelect = function( widget ) {
		...
		$.extend( widget, {
			...
			open: function() {
				...
				//Chris: I am getting bad behavior from dialog-based selectmenus
				// rather than debug it I will first disable it
				// if it turns out they are good for mobile devices I might go back ...
				if (false) {	//( menuHeight > screenHeight - 80 || !$.support.scrollTop ) {
